...
| | ⭐ **AW Next** | Achievements | AW 2.x |
|---|:---:|:---:|:---:|
| Transports | ✅ Native toast + in-game overlay + OBS browser source | ✅ Native toast + animated overlay | ⚠️ Toast · Chromium · WebSocket · GNTP |
...
and source on 22 September 2026. A blank in someone else's column usually means undocumented rather
than impossible, and every one of these projects moves fast.</sub>
